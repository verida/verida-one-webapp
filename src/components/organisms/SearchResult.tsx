  ...
  if (data || isLoading) {
    return (
      <>
        ...
        />
        <div className="fixed top-0 z-50 mt-16 w-full border-t border-solid border-gray-dark sm:left-1/2 sm:top-0 sm:max-w-screen-sm sm:-translate-x-1/2 sm:rounded-xl sm:bg-background/80 sm:backdrop-blur-[10px] md:w-2/4">
